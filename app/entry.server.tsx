...
import i18next from "./core/lib/i18next.server"; // 서버 사이드 i18n 인스턴스
import i18n from "./i18n"; // 공유 i18n 설정
import en from "./locales/en"; // 영어 번역
import es from "./locales/es"; // 스페인어 번역
import ko from "./locales/ko"; // 한국어 번역
