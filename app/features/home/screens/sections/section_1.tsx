...
export default function Section1() {
  ...
  return (
    <section className="relative h-[70vh] w-full xl:h-screen">
      ...
      {/*왼쪽 하단 원형 그라데이션 */}
      <div className="absolute bottom-[100px] -left-[20%] h-[300px] w-[300px] rounded-full bg-[linear-gradient(to_left,#7C4DFF,#ffffff)] opacity-20 blur-xl md:-left-[10%] md:h-[600px] md:w-[600px] dark:bg-[linear-gradient(to_left,#7C4DFF,#000)] dark:opacity-30"></div>

      {/* 오른쪽 상단 원형 그라데이션 */}
      <div className="absolute top-0 -right-[0%] h-[300px] w-[300px] rounded-full bg-[linear-gradient(to_left,#7C4DFF,#ffffff)] opacity-20 blur-xl md:h-[600px] md:w-[600px] dark:bg-[linear-gradient(to_left,#7C4DFF,#000)] dark:opacity-20"></div>
      ...
      >
        ...
        <motion.p
          variants={reduce ? undefined : itemVariants}
          className="text-text-body md:text-h6 text-text-2/80 dark:text-text-2 mt-4 mb-14 xl:mb-18"
        >
