...
export default function LectureCard({
  ...
  return (
    ...
    >
      {/* img 영역 */}
      <div className="group relative h-full max-h-[200px] min-h-[200px] w-full overflow-hidden rounded-xl bg-gray-100 xl:block xl:max-h-[400px] xl:min-h-[300px] xl:rounded-[20px] 2xl:min-h-[450px] dark:bg-gray-900">
        {lecture.imageUrl ? (
          <img
